...
{
    class ConduitFlowSensorGas : IBuildingConfig
    {
        public const string ID = "Nightinggale.ConduitFlowSensorGas";
        ...
        public static LocString LOGIC_PORT = "Internal " + UI.FormatAsLink("Gas", "ELEMENTS_GAS") + " Flow";
